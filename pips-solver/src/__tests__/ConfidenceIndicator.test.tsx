...
describe('ConfidenceIndicator', () => {
  ...
  describe('isBorderlineConfidence', () => {
    ...
    it('should detect borderline near high threshold', () => {
      ...
      expect(isBorderlineConfidence(0.80)).toBe(true);  // 0.85 - 0.05
      expect(isBorderlineConfidence(0.90)).toBe(true);  // 0.85 + 0.05
    });
    ...
    it('should detect borderline near medium threshold', () => {
      ...
      expect(isBorderlineConfidence(0.65)).toBe(true);  // 0.70 - 0.05
      expect(isBorderlineConfidence(0.75)).toBe(true);  // 0.70 + 0.05
    });
